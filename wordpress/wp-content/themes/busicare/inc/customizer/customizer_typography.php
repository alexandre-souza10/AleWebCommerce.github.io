...
$wp_customize->add_section('local_google_font',
	array(
		'title' => esc_html__('Performance(Google Font)', 'busicare'),
		'panel' => 'busicare_typography_setting',
		'priority' => 1
	));


$wp_customize->add_setting('busicare_enable_local_google_font',
	array(
		'default' => true,
		'sanitize_callback' => 'busicare_sanitize_checkbox',
	)
);
$wp_customize->add_control(new Busicare_Toggle_Control( $wp_customize, 'busicare_enable_local_google_font',
	array(
		'label' => esc_html__('Load Google Fonts Locally?', 'busicare'),
		'type' => 'toggle',
...
// Enable/Disable Header typography section
    ...
    $wp_customize->add_control('enable_header_typography', array(
        'label' => esc_html__('Enable/Disable to apply the settings', 'busicare'),
