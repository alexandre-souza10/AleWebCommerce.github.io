...
jQuery(function(){
	jQuery('#customize-control-appointment_options-home_banner_enabled').before('<div class="video-guide"><a target="_blank" href="https://youtu.be/1ZwtCfQUxyg?si=U5ihZOMpnO5L5r7h" class="video-icon" >Video Guide<span class="dashicons dashicons-video-alt3 video-tutorial"></span></a></div>');
    jQuery('#accordion-section-service_section_head').before('<div class="video-guide"><a target="_blank" href="https://youtu.be/jIprf8zkQ4I?si=fFOv9gcwxzM5a-Ck" class="video-icon" >Video Guide<span class="dashicons dashicons-video-alt3 video-tutorial"></span></a></div>');
    jQuery('#customize-control-appointment_options-home_blog_enabled').before('<div class="video-guide"><a target="_blank" href="https://youtu.be/9AG7NuMtx48?si=AnEIPFYk5x2EirRA" class="video-icon" >Video Guide<span class="dashicons dashicons-video-alt3 video-tutorial"></span></a></div>');
    jQuery('#accordion-section-appointment_header_typography').before('<div class="video-guide"><a target="_blank" href="https://youtu.be/3FKZ9262Ke0?si=ehoDcrBR6xH4awaU" class="video-icon" >Video Guide<span class="dashicons dashicons-video-alt3 video-tutorial"></span></a></div>');
});