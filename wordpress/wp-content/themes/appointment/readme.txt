...
@version 3.4.3
1. Fixed meta tag issue on Single Page&Latest News Section.
@version 3.4.2
1. Updated copyright text as partial editable.
@version 3.4.1
1. Added Post navigation section. 
2. Added Related Post Section. 
3. Fixed breadcrumbs issue.
@version 3.4
1. Added Video Tutorials links in customizer. 
2. Added Video Tutorials tab in options page.
@version 3.3.3
1. Added Rank Math, Seo Yoast and NavXT Breadcrumbs Feature.
@version 3.3.2
1. Updated the strings and fixed the translation issues.
@version 3.3.1
